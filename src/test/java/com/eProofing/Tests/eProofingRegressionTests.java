...
public class eProofingRegressionTests extends eProofingProperties{
  ...
  public void beforeMethod() 
  {
	 ...
	 extent = new ExtentReports(System.getProperty("user.dir")+"\\EproofingExtentReports\\"+"RegressionReport"+".html");
	 //extent.addSystemInfo("Host Name", "SoftwareTestingMaterial").addSystemInfo("Environment", "Automation Testing").addSystemInfo("User Name", "Vidya Suryavanshi");
